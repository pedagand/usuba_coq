...
let
    ...
    for i in 0 to 7 do
      (round, (IInd (Var_e i + 1)%ua_aexpr :: ISlice (Const_e 0 :: Const_e 1 :: nil) :: nil))%ua_var :: nil <|- [f @ [Index round (IInd i :: IInd 0 :: nil)] xor (Index round (IInd i :: IInd 1 :: nil)) xor (Const 0xfffffffe (Some u32)) xor ((rc >> i) & (Const 1 (Some u32))), (Index round (IInd i :: IInd 0 :: nil))]
    done;
...
let
    ...
    (B', nil) :: nil  <|- B  xor C' xor [0,SC[0]] xor [0xffffffff, Const 0xffffff00 (Some u32)];
    (D', nil) :: nil  <|- D  xor E' xor [0,SC[1]] xor [0xffffffff, Const 0xffffff00 (Some u32)];
    (E'', nil) :: nil <|- E' xor A' xor [0,SC[2]] xor [0xffffffff, Const 0xffffff00 (Some u32)];
...
let
    (SC, nil) :: nil <|- [0x50,0x5c,0x91,0x8d,0x53,0x60,0x68,0xe1,0xf6,0x9d,0x40,0x4f,0xbe,0x5b,0xe9,0x7f,
          ...
          0x14,0x57,0x24,0x63,0x54,0x18,0x9a,0x38,0xbd,0x67,0x10,0x13,0x2f,0xd6,0xba,Const 0x1f (Some u32)];
    (RC, nil) :: nil <|- [0x07,0x0a,0x9b,0xe0,0xd1,0x1a,0x22,0xf7,0x62,0x96,0x71,0xaa,0x2b,0xe9,0xcf,0xb7,
          ...
          0x43,0xe4,0x5e,0xcc,0x32,0x4e,0x75,0x25,0xfd,0xf9,0x76,0xa0,0xb0,0x09,0x1e,Const 0xad (Some u32)];
